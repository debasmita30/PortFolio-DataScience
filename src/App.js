...
export default function App() {
  ...
  const projects = [
    {
      title: "GenAI-Driven Pricing Optimization Engine",
      tech: "TensorFlow · Keras · PPO · Streamlit",
      desc:
        "Built a GenAI-based dynamic pricing system using reinforcement learning to optimize real-time pricing and recommendations with interactive dashboards.",
      github:
        "https://github.com/debasmita30/Gen-AI-Powered-Customer-Insights-Recommendation-System",
    },
    {
    ...
    {
      title: "AI-Powered Return Validation System",
      tech: "TensorFlow · Scikit-learn · NLP · CV",
      desc:
        "Built an NLP and CV-powered fraud detection and defect validation pipeline achieving 90%+ accuracy with Streamlit dashboards.",
      github: "https://github.com/debasmita30/ai-return-assistant",
    },
  ];
  ...
  const certifications = [
    ...
    {
      name: "IBM Generative AI Engineering — Coursera (Aug 2025)",
      link: "https://www.coursera.org/account/accomplishments/professional-cert/G79ORW4P8K12",
    },
    {
      name: "Microsoft AI & ML Engineering — Coursera (Aug 2025)",
      link: "https://www.coursera.org/account/accomplishments/professional-cert/SCTQIBDH2AY1",
    },
    {
      name: "MLOps | Machine Learning Operations — Coursera (Sep 2025)",
      link: "https://www.coursera.org/account/accomplishments/specialization/8OR7RNN4YUQT",
    },
    {
  ...
  const skillLinks = {
    ...
    StatisticalModeling: "https://www.coursera.org/articles/statistical-modeling",
    HypothesisTesting: "https://www.geeksforgeeks.org/software-testing/understanding-hypothesis-testing/",
    A/B Testing: "https://www.geeksforgeeks.org/blogs/what-is-a-b-testing/",
    "Regression Classification" : "https://www.geeksforgeeks.org/machine-learning/regression-in-machine-learning/",
    ...
    Cohort Analysis: "https://numpy.org/",
    "Funnel Analysis": "https://www.statmodeling.com/",
    ...
    <div className="min-h-screen bg-[#050517] text-white antialiased relative overflow-hidden">
      ...
      <header id="home" className="relative h-screen flex items-center justify-center">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          >
            Building Emotionally Intelligent AI & GenAI systems — merging{" "}
      ...
      <section id="about" className="py-20 bg-gradient-to-br from-[#07102a] via-[#0c1838] to-[#071022] flex flex-col md:flex-row items-center justify-center gap-10">
        ...
        >
          ...
          <p className="text-white/80 leading-relaxed text-lg">
            Data Analytics and Machine Learning enthusiast with hands-on experience in Python, SQL, Power BI, and Tableau. Skilled in GenAI and ML-driven data analysis, building interactive dashboards, and delivering actionable insights. Experienced in collaborating with cross-functional teams to solve real-world business problems and drive data-backed decisions.
          </p>
        </motion.div>
        <motion.img
